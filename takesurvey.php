...
<head>
    ...
    <!--
        File name : takesurvey.php
        Author's name : 
        Web site name : Project Survey
        This is take survey page
    -->
    <title>Project Survey - Login</title>
...
<body>
    ...
    <div id='topnav'>
        ...
        <my_menu><a class="m_normal" href='createsurvey.php'>Create Survey</a></my_menu>
        <my_menu><a class="m_active" href='takesurvey.php'>Take Survey</a></my_menu>
